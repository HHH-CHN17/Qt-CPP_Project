...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NetWorkTest_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NetWorkTest_t qt_meta_stringdata_NetWorkTest = {
    {
QT_MOC_LITERAL(0, 0, 11), // "NetWorkTest"
QT_MOC_LITERAL(1, 12, 14), // "SlotHostDetail"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "NetWorkTest\0SlotHostDetail\0"
};
...
void NetWorkTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NetWorkTest *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SlotHostDetail(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
QT_INIT_METAOBJECT const QMetaObject NetWorkTest::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_NetWorkTest.data,
    qt_meta_data_NetWorkTest,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *NetWorkTest::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetWorkTest.stringdata0))
